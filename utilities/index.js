  ...
  return `
    <section class="vehicle-detail-section">
      <div class="vehicle-detail">
        <img class="vehicle-img" src="${vehicle.inv_image}" alt="Image of ${vehicle.inv_make} ${vehicle.inv_model}">
...
Util.buildDetailView = buildDetailView

/* **************************************
* Build the Classification List view
* ************************************ */
